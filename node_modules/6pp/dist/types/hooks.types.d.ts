...
type SocketEventHandlers<T extends Record<string, any[]>> = {
    [K in keyof T]: (...args: T[K]) => void;
};
export type { UseFetchDataParams, UseMutionParams, ConfirmModalProps, UseConfirmModalProps, UseRatingPropsType, SocketEventHandlers, };
